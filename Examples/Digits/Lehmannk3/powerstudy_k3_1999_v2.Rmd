...
# load(file="~/nout/Examples/Digits/Lehmannk3/resDigits0.1k3_1999_v2")
# results = compact_resultsk3(resDigits0.1k3_1999_v2$raw.res)
...
```{r warning=FALSE, message=FALSE}
load(file = paste0("~/nout/Examples/Digits/Lehmannk3","/matrixDigits0.1k3_1999_v2"))
