...
resDigits0.1k3_2999 = list("raw.res"=res, 
                      "unconditional.power" = unconditional.power, 
                      "compact.results" = results)
save(resDigits0.1k3_2999, file="~/nout/Examples/Digits/Lehmannk3/resDigits0.1k3_2999")
...
load(file="~/nout/Examples/Digits/Lehmannk3/resDigits0.1k3_2999")
...
for(j in 1:length(n1s)){
  d_BH[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.lb.d[1]
  d_StoBH[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.lb.d[2]
  d_Sim[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.lb.d[3]
  d_StoSimes[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.lb.d[4]
  d_WMW[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.lb.d[5]
  d_T3[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.lb.d[6]
  
  pow.rejGlob_BH[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.powerGlobalNull[1]
  pow.rejGlob_StoBH[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.powerGlobalNull[2]
  pow.rejGlob_Sim[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.powerGlobalNull[3]
  pow.rejGlob_StoSimes[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.powerGlobalNull[4]
  pow.rejGlob_WMW[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.powerGlobalNull[5]
  pow.rejGlob_T3[j] = resDigits0.1k3_2999$compact.results[[j]]$mean.powerGlobalNull[6]
...
matrixDigits0.1k3_2999 = list("lb.d.matrix" = lb.d, 
                         "pow.rejGlob.matrix" = pow.rejGlob)
save(matrixDigits0.1k3_2999, 
     file = paste0("~/nout/Examples/Digits/Lehmannk3","/matrixDigits0.1k3_2999"))
...
```{r warning=FALSE, message=FALSE}
load(file = paste0("~/nout/Examples/Digits/Lehmannk3","/matrixDigits0.1k3_2999"))

res = matrixDigits0.1k3_2999
