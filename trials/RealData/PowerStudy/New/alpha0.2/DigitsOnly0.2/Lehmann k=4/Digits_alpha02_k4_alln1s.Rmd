...
author: "k=4, proportion of outliers from 0 to 1"
date: '`r Sys.Date()`'
output: pdf_document
---
...
We consider Lehmann's alternative with $k = 4$ and we show that the theoretical result that closed testing procedure with Wilcoxon-Mann-Whitney local test is the Locally Most Powerful Invariant test for the global null is validated also by numerical simulations.
...
m = 249
n = 50
k = 4 # exponent of Lehmann's alternative
myalpha = n/(m+1)
...
resDigits_alpha02_k4_alln1s = results
save(resDigits_alpha02_k4_alln1s,
     file="~/nout/trials/RealData/PowerStudy/New!/alpha0.2/DigitsOnly0.2/Lehmann k=4/resDigits_alpha02_k4_alln1s")
