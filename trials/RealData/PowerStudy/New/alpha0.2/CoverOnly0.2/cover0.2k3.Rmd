...
data = readMat("~/nout/trials/RealData/Datasets/Dataset covertype/cover.mat")
...
resCovertypek3 = res
save(resCovertypek3, file="~/nout/trials/RealData/PowerStudy/New!/alpha0.2/CoverOnly0.2/resCovertypek3")
