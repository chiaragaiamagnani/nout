---
title: "Power analysis on Cover dataset"
...
The aim is to compare on Covertype datasets the performance of three closed testing procedures, which respectively use Simes local test with and without Storey estimator for the proportion of true null hypotheses and Wilcoxon-Mann-Whitney local test.
...
## Covertype dataset
Covertype dataset (available at http://odds.cs.stonybrook.edu/forestcovercovertype-dataset) consists of $288795$ observations, among which $n_{inliers}=286048$ items are inliers and the remaining $n_{outliers}=2747$ are outliers.
...
In the case of Covertype dataset we obtain $l=133025, \hspace{2mm} m=9999, \hspace{2mm} n=2000$.
...
boxplot(results$discoveries, main="Cover | Distribution of the number of discoveries")
...
resCover0 = results
save(resCover0,
     file="~/nout/trials/RealData/PowerStudy/New!/alpha0.2/CoverOnly0.2/resCover0")
...
resCover10 = results
save(resCover10,
     file="~/nout/trials/RealData/PowerStudy/New!/alpha0.2/CoverOnly0.2/resCover10")
