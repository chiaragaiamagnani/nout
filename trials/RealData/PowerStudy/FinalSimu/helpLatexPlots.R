...
for(j in 1:length(n1s)){
  ...
  d_BH[j] = resDigits0.1$compact.results[[j]]$mean.lb.d[1]
  #d_StoBH[j] = resDigits0.1$compact.results[[j]]$mean.lb.d[2]
  d_Sim[j] = resDigits0.1$compact.results[[j]]$mean.n.disc[3]
  #d_StoSimes[j] = resDigits0.1$compact.results[[j]]$mean.n.disc[4]
  d_WMW[j] = resDigits0.1$compact.results[[j]]$mean.n.disc[4]
...
colnames(n.disc) = c("FDR-BH", "CT-Simes", "CT-WMW")
n.disc[,1] = d_BH
n.disc[,2] = d_Sim
n.disc[,3] = d_WMW
View(n.disc)
...
for(j in 1:length(n1s)){
  ...
  d_BH[j] = resCreditCard0.1v2$compact.results[[j]]$mean.lb.d[1]
  #d_StoBH[j] = resCreditCard0.1v2$compact.results[[j]]$mean.lb.d[2]
  d_Sim[j] = resCreditCard0.1v2$compact.results[[j]]$mean.n.disc[3]
  #d_StoSimes[j] = resCreditCard0.1v2$compact.results[[j]]$mean.n.disc[4]
  d_WMW[j] = resCreditCard0.1v2$compact.results[[j]]$mean.n.disc[4]
...
for(j in 1:length(n1s)){
  d_BH[j] = resShuttle0.1v2$compact.results[[j]]$mean.lb.d[1]
  d_StoBH[j] = resShuttle0.1v2$compact.results[[j]]$mean.lb.d[2]
  d_Sim[j] = resShuttle0.1v2$compact.results[[j]]$mean.lb.d[3]
  d_StoSimes[j] = resShuttle0.1v2$compact.results[[j]]$mean.lb.d[4]
  d_WMW[j] = resShuttle0.1v2$compact.results[[j]]$mean.lb.d[5]
...
matrixShuttle0.1 = list("lb.d.matrix" = lb.d, "pow.rejGlob.matrix" = pow.rejGlob)
